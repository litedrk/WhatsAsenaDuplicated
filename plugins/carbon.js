...
if (Config.WORKTYPE == 'private') {
    ...
    DrkBot.addCommand({pattern: 'carbon$', fromMe: true, desc: Lang.CARBON_DESC}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(respoimage.data), MessageType.image, { mimetype: Mimetype.png, caption: `${MLang.by}`})

    }));
}
else if (Config.WORKTYPE == 'public') {

    DrkBot.addCommand({pattern: 'carbon$', fromMe: false, desc: Lang.CARBON_DESC}, (async (message, match) => {
